...
struct Z_Construct_UClass_AMaui_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_MauiFlipbook_MetaData[] = {
		{ "Category", "Maui" },
		{ "EditInline", "true" },
		{ "ModuleRelativePath", "Maui.h" },
	};
	...
	static const UECodeGen_Private::FObjectPropertyParams NewProp_MauiFlipbook;
...
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_AMaui_Statics::NewProp_CapsuleComp = { "CapsuleComp", nullptr, (EPropertyFlags)0x00100000000a000d, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AMaui, CapsuleComp), Z_Construct_UClass_UCapsuleComponent_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_CapsuleComp_MetaData), NewProp_CapsuleComp_MetaData) };
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_AMaui_Statics::NewProp_MauiFlipbook = { "MauiFlipbook", nullptr, (EPropertyFlags)0x00100000000a000d, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AMaui, MauiFlipbook), Z_Construct_UClass_UPaperFlipbookComponent_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_MauiFlipbook_MetaData), NewProp_MauiFlipbook_MetaData) };
...
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_AMaui_Statics::PropPointers[] = {
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AMaui_Statics::NewProp_CapsuleComp,
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AMaui_Statics::NewProp_MauiFlipbook,
